...
public class CreateObjectControllerTest {

    private CreateObjectController createObjectController;
    ...
    public void setUp() {
        ...
        createObjectController = new CreateObjectController(createObjectHandler);
    ...
    public void creationSuccess() {
        ...
        ObjectDto objectDto = this.createObjectController.createObject(this.getObjectCommand());
