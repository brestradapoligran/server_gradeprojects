...
public class UpdateObjectControllerTest {

    private UpdateObjectController updateObjectController;
    ...
    public void setUp() {
        ...
        updateObjectController = new UpdateObjectController(updateObjectHandler);
    ...
    public void creationSuccess() {
        ...
        ObjectDto objectDto = this.updateObjectController.updateObject("1", this.getObjectCommand());
