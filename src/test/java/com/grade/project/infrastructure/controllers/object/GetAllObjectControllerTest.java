...
public class GetAllObjectControllerTest {

    private GetAllObjectController getAllObjectController;
    ...
    public void setUp() {
        ...
        getAllObjectController = new GetAllObjectController(getAllObjectsHandler);
    ...
    public void creationSuccess() {
        ...
        List<ObjectDto> objectDtos = this.getAllObjectController.getObjects();
